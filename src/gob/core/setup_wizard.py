...
"""
    ...
    def print_complete_message(self):
        ...
        print(" 🔨 Usage Options:")
        print()
        print("   Option 1: Run GOB directly")
        print("   $ cd {}".format(self.project_root))
        print("   $ source venv/bin/activate")
        print("   $ gob.sh")
        print()
        print("   Option 2: pip install + command")
        print("   $ pip install -e .")
        print("   $ gob --tui")
        print()
        print("   Option 3: Python module")
        print("   $ python -m gob.main --mode tui")
        print()
        print(" 📋 Next Steps:")
        print("   1. Set OPENROUTER_API_KEY in .env (required)")
        print("   2. Optionally set DISCORD_BOT_TOKEN (optional)")
        print("   3. Run: gob.sh or python -m gob.main --mode tui")
        print("   4. See docs/quick-start.md for usage")
        print()
        print(" ℹ️  Documentation:")
        print("   - docs/quick-start.md")
